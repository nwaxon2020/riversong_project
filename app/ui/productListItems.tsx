...
export default function ProductListItems(){
    ...
    return(
        <div className="p-2 md:p-10 my-5 md:my-10 flex flex-wrap gap-2 justify-around items-start">
            {productListItems.map((prod)=>{
                return(
                    <div key={prod.id} className={"my-8 w-[10rem] md:w-[15rem] md:w-72 shadow-lg rounded-b-lg"}>
